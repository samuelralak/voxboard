...
- **Protocol:** Nostr. Boards are NIP-72 moderated communities (kind 34550); ideas and replies are NIP-22 comments (kind 1111). NIP-72 is marked "unrecommended" in favor of NIP-29, which puts the relay in charge of the group. Voxboard stays on NIP-72 so the owner stays in charge and boards work on any relay (see [PROTOCOL.md](./PROTOCOL.md)).
